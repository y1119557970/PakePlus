window.addEventListener("DOMContentLoaded",()=>{const t=document.createElement("script");t.src="https://www.googletagmanager.com/gtag/js?id=G-W5GKHM0893",t.async=!0,document.head.appendChild(t);const n=document.createElement("script");n.textContent="window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-W5GKHM0893');",document.body.appendChild(n)});document.addEventListener('contextmenu',function(e){const target=e.target;const isInput=target.tagName==='INPUT'||target.tagName==='TEXTAREA';const isContentEditable=target.isContentEditable;if(!isInput&&!isContentEditable){e.preventDefault()}});const SECRET_KEY = 'y1119557970s17628196973c19980215';
...
function verifyLicense(licenseKey, machineCode) {
  try {
    ...
    return { valid: true, expireTime: expire };
  } catch (err) {
  ...
  if (!authorized) {
    ...
    modal.innerHTML = `
      <div style="text-align: center; margin-bottom: 20px;">
        ...
        <h2 style="color: #1f2937; margin: 20px 0 10px; font-size: 24px;">会员授权验证</h2>
